...
let correct_answers = 0;
 ...
 function populateText(){
    ...
    let hint_header = $(" <div class='practiceHintText need-hint'>Need a hint?</div><button class='btn  '  id='showHint' type='button' onclick='toggleHint()'>Show ingredients list</button>");
