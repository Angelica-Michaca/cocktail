...
function featureCocktails(){
  let new_card = $("<div class = 'col-md-4 '><div class='card custom-card customHomeCard center-text'> <div class = 'ratio-images'> <img class='card-img-top' src='" + cocktails[drink]['image'] + "' alt='card image cap' /> </div> <div class='card-body'> <div class='btn-container'> <a href=" + cocktails[drink]['learnUrl'] + "><button class='btn-in-home-cards learn-drink-btn whiteBtn'>" + cocktails[drink]['name']+ "</button></a> <a  href=" + cocktails[drink]['quizUrl'] + "><button class='take-quiz-btn btn btn-in-home-cards'>Take the Quiz</button></a></div></div></div></div>") 
